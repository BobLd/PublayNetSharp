namespace PublayNetSharp
{
    ...
    /// </summary>
    internal class PageXmlTextExporter
    {
        private string indentChar;

        int regionCount = 0;
        readonly Dictionary<int, string> categories;
        ...
        public PageXmlTextExporter(Dictionary<int, string> categories, string indent = "\t")
        {
        ...
        public string Get(CocoEntry page)
        {
            ...
            pageXmlDocument.Page = ToPageXmlPage(page);

            return Serialize(pageXmlDocument);
        }

        private string PointToString(PointF point)
        {
        ...
        private string ToPoints(IEnumerable<PointF> points)
        {
        ...
        private string ToPoints(RectangleF pdfRectangle)
        {
        ...
        private PageXmlDocument.PageXmlCoords ToCoords(RectangleF pdfRectangle)
        {
        ...
        private PageXmlDocument.PageXmlCoords ToCoords(IEnumerable<PointF> points)
        {
            return new PageXmlDocument.PageXmlCoords()
            {
        ...
        private PageXmlDocument.PageXmlPage ToPageXmlPage(CocoEntry page)
        {
            ...
            foreach (var annotation in page.Annotations)
            {
                ...
                //var segmentations = annotation.GetBBoxRectangle();
        ...
        private PageXmlDocument.PageXmlImageRegion ToPageXmlImageRegion(int id, IEnumerable<PointF> segmentation)
        {
            regionCount++;
        ...
        private PageXmlDocument.PageXmlImageRegion ToPageXmlImageRegion(int id, RectangleF bbox)
        {
            regionCount++;
            return new PageXmlDocument.PageXmlImageRegion()
            {
        ...
        private PageXmlDocument.PageXmlTextRegion ToPageXmlTextRegion(int id, IEnumerable<PointF> segmentation, PageXmlDocument.PageXmlTextSimpleType type)
        {
            regionCount++;
            return new PageXmlDocument.PageXmlTextRegion()
            {
                Coords = ToCoords(segmentation),
                Type = type,
                //TextEquivs = new PageXmlDocument.PageXmlTextEquiv[] { new PageXmlDocument.PageXmlTextEquiv() { PlainText = "" } },
                Id = "r" + id.ToString()
            };
        }

        private PageXmlDocument.PageXmlTextRegion ToPageXmlTextRegion(int id, RectangleF bbox, PageXmlDocument.PageXmlTextSimpleType type)
        {
            regionCount++;
            return new PageXmlDocument.PageXmlTextRegion()
            {
        ...
        private PageXmlDocument.PageXmlTableRegion ToPageXmlTableRegion(int id, IEnumerable<PointF> segmentation)
        {
            regionCount++;
        ...
        private PageXmlDocument.PageXmlTableRegion ToPageXmlTableRegion(int id, RectangleF bbox)
        {
            regionCount++;
            return new PageXmlDocument.PageXmlTableRegion()
            {
        ...
        private PageXmlDocument.PageXmlUnknownRegion ToPageXmlUnknownRegion(int id, IEnumerable<PointF> segmentation)
        {
            regionCount++;
        ...
        private PageXmlDocument.PageXmlUnknownRegion ToPageXmlUnknownRegion(int id, RectangleF bbox)
        {
            regionCount++;
            return new PageXmlDocument.PageXmlUnknownRegion()
            {
